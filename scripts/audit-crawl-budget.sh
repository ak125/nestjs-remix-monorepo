...
# ðŸ” AUDIT CRAWL BUDGET - Script CLI
# â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
#
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --output)
      ...
      ;;
    *)
      echo -e "${RED}âŒ Option inconnue: $1${NC}"
      exit 1
      ;;
  esac
done
...
echo -e "${BLUE}ðŸ” Audit Crawl Budget - URLs App vs GSC vs GA4${NC}"
echo -e "${BLUE}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${NC}"
echo ""
...
echo -e "${YELLOW}ðŸ“¡ VÃ©rification connexion backend...${NC}"
if ! curl -sf "$BACKEND_URL/seo-logs/crawl-budget/stats" > /dev/null 2>&1; then
  echo -e "${RED}âŒ Backend inaccessible Ã  $BACKEND_URL${NC}"
  echo -e "${YELLOW}ðŸ’¡ Assurez-vous que le backend est dÃ©marrÃ©:${NC}"
...
# Lancer l'audit
echo -e "${YELLOW}ðŸ” Lancement de l'audit...${NC}"
echo ""
...
if ! echo "$RESPONSE" | jq -e '.success' > /dev/null 2>&1; then
  echo -e "${RED}âŒ Erreur lors de l'audit${NC}"
  echo "$RESPONSE" | jq '.'
  exit 1
fi
...
# GÃ©nÃ©rer rapport texte
{
  ...
  echo "ðŸ” RAPPORT D'AUDIT CRAWL BUDGET"
  echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
  echo ""
  ...
  echo ""
  echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
  echo "ðŸ”€ COMPARAISON CROISÃ‰E"
  echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
  echo ""
  echo "âœ… Perfect match (app + GSC + GA4):  $PERFECT_MATCH URLs"
  echo "ðŸ“¤ Uniquement dans app:              $APP_ONLY URLs"
  echo "ðŸ“¥ Uniquement dans GSC:              $GSC_ONLY URLs"
  ...
  if [ "$APP_ONLY" -gt 0 ]; then
    echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
    echo "ðŸ“¤ TOP 10 URLs app non crawlÃ©es"
    echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
    echo ""
  ...
  if [ "$GSC_ONLY" -gt 0 ]; then
    echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
    echo "ðŸ“¥ TOP 10 URLs GSC orphelines"
    echo "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
    echo ""
...
echo -e "${GREEN}ðŸŽ‰ Audit terminÃ© avec succÃ¨s !${NC}"
echo -e "${GREEN}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${NC}"
echo ""
...
if (( $(echo "$MATCH_RATE >= 80" | bc -l) )); then
  ...
  echo -e "${RED}ðŸš¨ Critique: $MATCH_RATE% de matching${NC}"
fi
echo ""
