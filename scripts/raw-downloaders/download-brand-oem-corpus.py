...
Ancien rôle : téléchargeait un corpus brut multi-source par marque (Wikipedia,
Wikidata, NHTSA, Rappel Conso) vers `recycled/rag-knowledge/web/brands/`,
alimentant l'ancien pipeline content-RAG.
