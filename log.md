...
## 2026-05-15 — feat/seo-governance-control-plane-phase-d (auto)

- **Branche** : `feat/seo-governance-control-plane-phase-d`
- **Décision** : feat(seo): pr-c opa write gateway + scanner anti-bypass (single write path)
- **Sortie** : PR aucune | commits 9b8055cb3
