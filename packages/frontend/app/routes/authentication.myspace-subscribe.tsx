...
export default function AuthenticationMyspaceSubscribePage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="authentication-myspace-subscribe-page">
      <h1>Authentication Myspace Subscribe - {loaderData.module}</h1>
