...
export default function AuthenticationMyspaceConnectPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="authentication-myspace-connect-page">
      <h1>Authentication Myspace Connect - {loaderData.module}</h1>
