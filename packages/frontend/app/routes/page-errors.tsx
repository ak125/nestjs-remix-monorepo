...
export const meta: MetaFunction = () => {
  return [
    { title: "Page-errors - Modern App" },
    { name: "description", content: "Gestion des page-errors" },
  ];
};
      ...
      <div className="max-w-4xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            Interface de gestion pour les page-errors
          </p>
        </header>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <button className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">
                  Voir tous les page-errors
                </button>
                <button className="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition-colors">
                  Créer un nouveau page-errors
                </button>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
                  Cette interface permet de gérer les page-errors du système.
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-4 rounded-lg text-center">
            ...
            <p className="text-sm text-blue-600 mt-1">
              CRUD complet pour les page-errors
            </p>
          </div>
