...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            rm_build_log: {
                Row: {
                    ...
                    rmbl_status_after: Database["public"]["Enums"]["rm_build_status_enum"] | null;
                    rmbl_status_before: Database["public"]["Enums"]["rm_build_status_enum"] | null;
            ...
            rm_listing: {
                Row: {
                    rml_build_status: Database["public"]["Enums"]["rm_build_status_enum"] | null;
            ...
            rm_rebuild_queue: {
                Row: {
                    ...
                    rmrq_status: Database["public"]["Enums"]["rm_rebuild_status_enum"] | null;
        ...
        Functions: {
            ...
            build_article_decisions: {
                Args: {
                    p_batch_id: number;
                };
                Returns: Json;
            };
            build_brand_decisions: {
                Args: {
                    p_batch_id: number;
                };
                Returns: Json;
            ...
            merge_staging_brands: {
                Args: {
                    p_import_id: number;
                };
                Returns: number;
            };
            migrate_psf_plaquettes: {
                Args: never;
                Returns: number;
            };
        ...
        Enums: {
            ...
            rm_stock_status_enum: "IN_STOCK" | "LOW_STOCK" | "OUT_OF_STOCK" | "PREORDER";
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly kg_risk_level: readonly ["low", "medium", "high", "critical"];
            readonly rm_build_status_enum: readonly ["PENDING", "READY", "PARTIAL", "FAILED", "EMPTY"];
            readonly rm_quality_enum: readonly ["OE", "EQUIV", "ECO"];
            readonly rm_rebuild_status_enum: readonly ["PENDING", "PROCESSING", "DONE", "FAILED"];
            readonly rm_stock_status_enum: readonly ["IN_STOCK", "LOW_STOCK", "OUT_OF_STOCK", "PREORDER"];
            readonly seo_page_role: readonly ["R1", "R2", "R3", "R4", "R5", "R6"];
        };
    };
};
export {};
//# sourceMappingURL=supabase-generated.types.d.ts.map