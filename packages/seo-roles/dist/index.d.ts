...
export { LEGACY_ROLE_ALIASES, PAGE_TYPE_TO_ROLE, ROLE_TO_PAGE_TYPE, FORBIDDEN_ROLE_IDS, DEPRECATED_OUTPUT_ROLES, setLegacyResolutionHook, type LegacyResolutionEvent, type LegacyResolutionHook, } from "./legacy";
