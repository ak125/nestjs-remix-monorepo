...
module.exports = {
  ...
  theme: {
    extend: {
      // 🎨 DESIGN TOKENS - Importés depuis @fafa/design-tokens
      colors: {
        ...
        // Accent (Couleurs branding custom)
        khmerCurry: '#ED5555',
        ...
        // Compatibilité shadcn/ui (gardées pour migration progressive)
      ...
      // Spacing (Design Tokens - 8px Grid System)
      spacing: {
        '0': '0',
        // 🎯 Système 8px Grid (Sémantique)
        'xs': '4px',   // Micro-espaces (badges, icônes)
        ...
        '5xl': '80px', // Extra large
        '6xl': '96px', // Maximum
        // Valeurs numériques (compatibilité)
        '1': '0.25rem',
        '2': '0.5rem',
        '3': '0.75rem',
        '4': '1rem',
