...
| Per-route bundle (chunks chargés par route X) | Nécessite parser le manifest Vite/Remix | `Total JS` budget couvre l'aggrégat ; `Initial load` budget couvre le path critique |
