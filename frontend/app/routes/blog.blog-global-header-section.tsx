...
export default function BlogBlogGlobalHeaderSectionPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="blog-blog-global-header-section-page">
      <h1>Blog Blog Global Header Section - {loaderData.module}</h1>
