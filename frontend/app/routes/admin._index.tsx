...
// Pas de loader — les stats sont chargees par le layout parent (admin.tsx)
// et lues via useRouteLoaderData("routes/admin")
...
export default function AdminDashboard() {
  ...
  const apiErrors = parentData?.apiErrors ?? null;
  const hasErrors = !!apiErrors;
  const criticalError = null;
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div className="p-6">
          ...
          {/* Design System */}
          {activeTab === "design" && <DashboardDesignTab />}
