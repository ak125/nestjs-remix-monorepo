// ðŸŽ¨ VERSION AMÉLIORÉE "€” PAGE CATALOGUE CONSTRUCTEUR
...
export default function BrandCatalogPage() {
  ...
  // ðŸŽ¨ Récupérer la couleur thématique du constructeur
  ...
  // ðŸ–¼ï¸ Mapping pour les logos qui ont un nom différent de l'alias DB
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ðŸŽï¸ Hero Section - Couleur thématique du constructeur */}
      <section
        ...
        <div className="relative z-10 container mx-auto px-4 max-w-7xl">
          ...
          <div className="max-w-5xl mx-auto mb-8 md:mb-10 animate-in fade-in duration-1000 delay-200">
            <div className="bg-gradient-to-br from-white/[0.18] to-white/[0.10] backdrop-blur-xl rounded-3xl shadow-[0_20px_80px_rgba(0,0,0,0.4)] p-6 md:p-8 border border-white/30 hover:border-white/50 transition-all duration-500">
              ...
              {/* Layout horizontal : Logo + VehicleSelector côte Ã  côte */}
      ...
      {/* ðŸ“¦ Pièces populaires depuis l'API */}
      {apiParts.length > 0 && (
      ...
      {/* ðŸš— Véhicules les plus recherchés */}
      ...
      {/* ðŸ”— Schema.org - Données structurées SEO */}
      <script
...
// ðŸš— Composant Carte de véhicule API - Version améliorée avec SEO complet
function VehicleCard({
  ...
  return (
    ...
    >
      {/* ðŸ–¼ï¸ Image responsive du véhicule avec srcset */}
...
// ðŸ“¦ Composant Carte de pièce API - Version améliorée style ancien HTML avec multi-alias SEO
function ApiPartCard({
  ...
  // ðŸ”’ Contexte véhicule avec gestion des valeurs nulles/undefined
    ...
    >
      ...
      <div className="p-3 md:p-4 flex flex-col h-full">
        ...
        <div className="flex items-start gap-3 mb-3">
          {/* ðŸ–¼ï¸ Image responsive de la pièce avec srcset */}
