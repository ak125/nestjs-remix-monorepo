...
export default function AuthenticationMyspacePswdPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="authentication-myspace-pswd-page">
      <h1>Authentication Myspace Pswd - {loaderData.module}</h1>
