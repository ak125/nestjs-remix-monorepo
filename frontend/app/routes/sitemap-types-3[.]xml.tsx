// app/routes/sitemap-types-3[.]xml.tsx
/**
 * 🏎️ SITEMAP TYPES/MOTORISATIONS - Partie 3 (20001-30000)
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const response = await fetchWithRetry(
      `${SITEMAP_CONFIG.BACKEND_URL}/sitemap-v2/types-20001-30000`
    );
    ...
    return new Response(sitemap, {
      headers: {
        ...
        "X-Shard": "types-20001-30000",
      },
    });
  } catch (error) {
    const duration = Date.now() - startTime;
    logSitemapError('Types 3 (20001-30000)', error, duration);
