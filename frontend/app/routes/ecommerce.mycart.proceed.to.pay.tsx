...
export default function EcommerceMycartProceedToPayPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="ecommerce-mycart-proceed-to-pay-page">
      <h1>Ecommerce Mycart Proceed To Pay - {loaderData.module}</h1>
