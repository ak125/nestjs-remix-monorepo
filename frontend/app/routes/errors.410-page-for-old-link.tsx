...
export default function Errors_410-pageForOldLinkPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="errors-410-page-for-old-link-page">
      <h1>Errors 410 Page For Old Link - {loaderData.module}</h1>
