      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mb-10">
          ...
          >
            ...
            <span className="text-sm font-medium">Retour aux couleurs familles</span>
          </Link>
          ...
          <p className="text-lg text-gray-600">
            Visualisation de toutes les couleurs assignées aux {brands.length} marques automobiles
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {brands.map((brand) => {
            const brandColor = brandColorsService.getBrandGradient(brand.marque_alias);
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${brandColor} transition-all duration-300`}></div>
        ...
        <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-xl">
          ...
          <ul className="space-y-2 text-sm text-amber-800">
            <li>• Les couleurs sont mappées dans <code className="bg-amber-100 px-2 py-0.5 rounded">brand-colors.service.ts → getBrandGradient()</code></li>
            <li>• Chaque marque a un gradient unique basé sur son identité visuelle officielle</li>
            <li>• Les marques inconnues utilisent un fallback neutre gris : <code className="bg-amber-100 px-2 py-0.5 rounded">from-slate-600 via-gray-700 to-slate-800</code></li>
            <li>• Le gradient est appliqué automatiquement dans le hero de <code className="bg-amber-100 px-2 py-0.5 rounded">/constructeurs/&#123;brand&#125;.html</code></li>
            <li>• Contraste WCAG AA respecté (texte blanc sur tous les gradients)</li>
          </ul>
        </div>
      </div>
    </div>
