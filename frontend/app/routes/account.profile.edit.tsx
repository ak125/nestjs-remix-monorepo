...
export const meta: MetaFunction = () => [
  ...
  { name: "robots", content: "noindex, nofollow" },
  {
    tagName: "link",
    rel: "canonical",
    href: "https://www.automecanik.com/account/profile/edit",
  },
];
          ...
          <Form method="post" className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                L'adresse email ne peut pas être modifiée. Contactez le support
                si nécessaire.
              </p>
            </div>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button type="button" variant="outline" asChild>
                <a href="/account/profile">Annuler</a>
              </Button>
            </div>
          </Form>
        </CardContent>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="text-sm text-gray-600">
            <p className="mb-2">
              <strong>Note :</strong> Les modifications peuvent prendre quelques
              minutes pour être prises en compte.
            </p>
