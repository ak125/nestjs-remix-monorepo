...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const stats: BlogStats = {
      totalArticles:
        overview?.totalArticles || data?.data?.byType?.advice?.total || 0,
      totalViews:
        overview?.totalViews || data?.data?.byType?.advice?.views || 0,
      totalAdvice:
        overview?.totalAdvice || data?.data?.byType?.advice?.total || 0,
      totalGuides:
...
export const meta: MetaFunction = () => {
  return [
    { title: "Administration Blog - Dashboard Principal" },
    {
      name: "description",
      content:
        "Interface d'administration complète pour la gestion du blog automobile.",
    },
...
export default function AdminBlogSimplePage() {
  const { stats, isError, errorMessage, apiStatus, debugInfo } =
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Interface complète de gestion du blog automobile
              </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {stats.totalAdvice} articles publiés
                </p>
              </div>
            </Link>
