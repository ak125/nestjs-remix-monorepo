...
export async function loader({ params, request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    throw new Response('Erreur lors du chargement de la pièce', { status: 500 });
  }
}
...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  const description = piece.description || `${piece.nom} de marque ${piece.marque}, référence ${piece.reference}. ${piece.dispo ? 'En stock' : 'Sur commande'}.`;
...
export default function PieceDetailPage() {
  const { piece, vehiclesCompatibles, crossSelling } = useLoaderData<typeof loader>();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <Link to="/pieces/catalogue" className="hover:text-blue-600">Pièces</Link>
            <span>›</span>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">{piece.nom}</h1>
        ...
        {vehiclesCompatibles.length > 0 && (
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Véhicules compatibles</h2>
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {vehiclesCompatibles.slice(0, 9).map((vehicle: any, idx: number) => (
