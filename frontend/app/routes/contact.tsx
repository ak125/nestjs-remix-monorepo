...
export const meta: MetaFunction = () => {
  return [
    { title: "Contactez-nous | Support Client" },
    {
      name: "description",
      content:
        "Contactez notre équipe support pour toute question sur vos commandes, produits ou services. Réponse rapide garantie.",
    },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.automecanik.com/contact",
    },
  ...
  const contactData: ContactRequest = {
    ...
    vehicleInfo: {
      ...
      year: formData.get("vehicleYear")
        ? parseInt(formData.get("vehicleYear") as string)
        : undefined,
      licensePlate:
        (formData.get("licensePlate") as string)?.trim() || undefined,
    },
    ipAddress:
...
export default function ContactPage() {
  const { isAuthenticated, userEmail, userName, supportConfig } =
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center border-t-4 border-green-500">
            ...
            <div className="space-y-3 text-sm text-gray-600 mb-8">
              <p>
                Votre demande a été enregistrée et transmise à notre équipe
                support.
              </p>
              <p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button className="px-6 py-3   rounded-md" variant="blue" asChild>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Notre équipe est là pour vous aider. Décrivez votre demande et nous
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="font-semibold text-lg mb-4 flex items-center">
                <svg
                  className="w-5 h-5 text-semantic-info mr-2"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow p-6">
              <Form ref={formRef} method="post" className="space-y-6">
                ...
                {actionData?.error && (
                  <Alert
                    className="text-red-700 px-4 py-3 rounded-md"
                    variant="error"
                  >
                    <div className="flex">
                      <svg
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500">
                      Si votre demande concerne une commande
                    </p>
                  </div>
                </div>
                        ...
                        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-neutral-300 border-dashed rounded-md hover:border-gray-400 transition-colors">
                          <div className="space-y-1 text-center">
                            ...
                            <div className="flex text-sm text-gray-600">
                              <label
                                htmlFor="file-upload"
                                className="relative cursor-pointer bg-white rounded-md font-medium text-semantic-info hover:text-semantic-info/80 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-semantic-info"
                              >
                            ...
                            <p className="text-xs text-gray-500">
                              Images, PDF, documents jusqu'à 10MB chacun (max 5
                              fichiers)
                            </p>
                          </div>
                        </div>
                ...
                <div className="border-t pt-6">
                  <div className="flex items-start mb-6">
                    ...
                    >
                      ...
                      pour traiter ma demande conformément à notre{" "}
                      <Link
                        to="/legal/privacy"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      className="relative px-8 py-3   rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                      variant="blue"
                      type="submit"
