...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Dashboard principal pour la gestion du support client",
    },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.automecanik.com/support",
    },
...
export default function SupportDashboard() {
  const { stats, recentTickets, urgentTickets } =
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Vue d'ensemble de l'activité support client
            </p>
          </div>
              ...
              <div className="w-8 h-8 bg-muted rounded-md flex items-center justify-center">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-6a2 2 0 00-2 2v3a2 2 0 002 2h6V13z"
                  />
                </svg>
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`px-2 py-1 text-xs font-semibold rounded-full ${getPriorityColor(ticket.priority || "normal")}`}
                          >
