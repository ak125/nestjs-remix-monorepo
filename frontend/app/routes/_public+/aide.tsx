...
export const meta: MetaFunction = () => {
  return [
    { title: "Aide & Support - Automecanik" },
    {
      name: "description",
      content:
        "Trouvez de l'aide et du support pour vos commandes et questions",
    },
  ];
};
  ...
  const faqItems = [
    {
      ...
      reponse:
        "Ajoutez vos articles au panier, connectez-vous ou créez un compte, puis suivez le processus de commande.",
    },
    {
      question: "Quels sont les délais de livraison ?",
      reponse:
        "Les délais varient selon la disponibilité des pièces : 24-48h pour les pièces en stock, 3-7 jours pour les commandes spéciales.",
    },
    {
      question: "Puis-je annuler ma commande ?",
      reponse:
        "Oui, tant que votre commande n'est pas expédiée. Contactez-nous rapidement après votre commande.",
    },
    {
      question: "Comment identifier la bonne pièce ?",
      reponse:
        "Utilisez notre outil de recherche par véhicule ou contactez notre équipe technique avec votre numéro de châssis.",
    },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Nous sommes là pour vous aider ! Trouvez rapidement les réponses à vos
          questions ou contactez notre équipe.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-muted rounded-lg p-6 text-center">
          ...
          <button className="text-foreground font-semibold hover:underline">
            Démarrer le chat
          </button>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="text-gray-600 space-y-1">
                <p>
                  <strong>Lun-Ven:</strong> 8h00 - 18h00
                </p>
                <p>
