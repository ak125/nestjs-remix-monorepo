// app/routes/sitemap-types-5[.]xml.tsx
/**
 * 🏎️ SITEMAP TYPES/MOTORISATIONS - Partie 5 (40001-48918)
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const response = await fetchWithRetry(
      `${SITEMAP_CONFIG.BACKEND_URL}/sitemap-v2/types-40001-48918`
    );
    ...
    return new Response(sitemap, {
      headers: {
        ...
        "X-Shard": "types-40001-48918",
      },
    });
  } catch (error) {
    const duration = Date.now() - startTime;
    logSitemapError('Types 5 (40001-48918)', error, duration);
