    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="rounded-lg border bg-white shadow-sm p-6">
            ...
            <div className="mt-2">
              ...
              <p className="text-xs text-gray-500">commandes chargées</p>
            </div>
          </div>
          ...
          <div className="rounded-lg border bg-white shadow-sm p-6">
            ...
            <div className="mt-2">
              ...
              <p className="text-xs text-gray-500">clients différents</p>
            </div>
          </div>
          ...
          <div className="rounded-lg border bg-white shadow-sm p-6">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-medium">Commandes Payées</h3>
              <Package className="h-4 w-4 text-gray-400" />
            </div>
            <div className="mt-2">
        ...
        <div className="rounded-lg border bg-white shadow-sm">
          <div className="p-6">
            <h3 className="text-lg font-semibold">Premières Commandes ({orders.length} sur {data.total})</h3>
          </div>
              ...
              <div key={order.ord_id} className="p-4 border-b last:border-b-0 hover:bg-gray-50">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="font-medium">{order.ord_total_ttc}€</div>
                    <div className={`text-xs px-2 py-1 rounded ${
                      order.ord_is_pay === '1' || order.ord_is_pay === 1 
                        ? 'bg-green-100 text-green-800' 
                        : 'bg-yellow-100 text-yellow-800'
                    }`}>
                      {order.ord_is_pay === '1' || order.ord_is_pay === 1 ? 'Payé' : 'En attente'}
                    </div>
                  </div>
                </div>
              </div>
