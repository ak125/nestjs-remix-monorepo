...
export default function AuthenticationMyspacePswdProceedPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="authentication-myspace-pswd-proceed-page">
      <h1>Authentication Myspace Pswd Proceed - {loaderData.module}</h1>
