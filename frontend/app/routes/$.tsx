...
export async function loader({
  ...
  // 🛡️ RR8 single-fetch (navigation client) : request.url reste brut (suffixe
  // `.data`, ou `/_.data` pour un slash final). La détection garbage, les
  // quick-redirects et les résolveurs redirect/legacy lisent donc le chemin de
  // l'argument `url`, normalisé par React Router (encodage préservé) — sinon les
  // 301 legacy (/blog, /pieces-auto/*) ne se déclenchent pas en navigation
  // client (404 au lieu du 301). Voir incident 2026-06-25.
