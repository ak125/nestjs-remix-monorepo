...
> = {
  ...
  "Courroie, galet, poulie et chaîne": { bg: "bg-warning/5", border: "border-yellow-300", text: "text-yellow-900", gradient: "from-yellow-500 to-yellow-700", badge: "bg-warning/15 text-yellow-900 border-yellow-300" },
  ...
  "Eclairage": { bg: "bg-warning/5", border: "border-yellow-400", text: "text-yellow-900", gradient: "from-yellow-400 to-yellow-600", badge: "bg-warning/15 text-yellow-900 border-yellow-400" },
