...
export default function CatalogProductsCarGammeFichePage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="catalog-products-car-gamme-fiche-page">
      <h1>Catalog Products Car Gamme Fiche - {loaderData.module}</h1>
