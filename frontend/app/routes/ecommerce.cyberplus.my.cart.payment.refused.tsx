...
export default function EcommerceCyberplusMyCartPaymentRefusedPage() {
  const loaderData = useLoaderData();
  const actionData = useActionData();
  const [isLoading, setIsLoading] = useState(false);

  return (
    <div className="ecommerce-cyberplus-my-cart-payment-refused-page">
      <h1>Ecommerce Cyberplus My Cart Payment Refused - {loaderData.module}</h1>
