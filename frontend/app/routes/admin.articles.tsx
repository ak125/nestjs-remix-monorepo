...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  try {
    ...
    const demoArticles: Article[] = [
      {
        ...
        contenu:
          "Guide complet pour sélectionner les meilleures plaquettes de frein pour votre véhicule...",
        meta_description:
          "Découvrez comment choisir les plaquettes de frein adaptées à votre voiture",
      ...
      },
      {
        ...
        contenu:
          "Les étapes essentielles pour maintenir votre système de refroidissement en bon état...",
        meta_description:
          "Apprenez à entretenir efficacement le système de refroidissement de votre véhicule",
      ...
      },
      {
        ...
        contenu:
          "Tout ce qu'il faut savoir sur la révision de votre véhicule : périodicité, contrôles...",
        meta_description:
          "Le guide ultime pour comprendre et planifier la révision de votre automobile",
    ...
    if (type) {
      filteredArticles = demoArticles.filter(
...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Interface de gestion des articles du blog.",
    },
...
export default function AdminArticlesPage() {
  const { articles, totalCount, isError, errorMessage } =
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-3">
                        ...
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getTypeColor(article.type)}`}
                        >
