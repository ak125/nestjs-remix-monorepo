    ...
    const categories = [
      {
        ...
        keywords: ["frein", "plaquette", "disque", "etrier"],
      },
      {
        name: "Filtres",
        slug: "filtres",
        description: "Air, huile, habitacle, carburant",
        keywords: ["filtre", "air", "huile", "habitacle", "carburant"],
      },
      {
        name: "Amortisseurs",
        slug: "amortisseurs",
        description: "Avant, arrière, sport",
        keywords: ["amortisseur", "suspension"],
      },
      {
        name: "Batteries",
        slug: "batteries",
        description: "12V, Start&Stop, AGM",
        keywords: ["batterie", "start", "stop", "agm"],
      },
      {
        name: "Pneus",
        slug: "pneus",
        description: "Été, hiver, 4 saisons",
        keywords: ["pneu", "roue", "été", "hiver"],
      },
      {
        name: "Échappement",
        slug: "echappement",
        description: "Silencieux, catalyseur, ligne",
        keywords: ["echappement", "silencieux", "catalyseur", "pot"],
      },
      {
        name: "Éclairage",
        slug: "eclairage",
        description: "Ampoules, phares, LED",
        keywords: ["eclairage", "ampoule", "phare", "led", "feu"],
      },
      {
        name: "Accessoires",
        slug: "accessoires",
        description: "Tapis, housses, équipements",
        keywords: ["accessoire", "tapis", "housse"],
      },
    ];
    ...
    const groupedGuides: GuideGroup[] = categories.map((cat) => {
      const categoryGuides = guides.filter((guide) => {
        ...
        return cat.keywords.some(
          (keyword) => title.includes(keyword) || slug.includes(keyword),
        );
      });
...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  return [
    ...
    },
    {
      name: "keywords",
      content:
        "guide achat pièces auto, comparatif pièces, conseils achat, choisir pièces voiture, meilleures marques auto",
    },
    {
      tagName: "link",
      rel: "canonical",
      href: "https://www.automecanik.com/blog-pieces-auto/guide",
    },
...
export default function BlogGuidesIndex() {
  const { groupedGuides, allGuides, totalGuides, stats } =
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm">
                  Comparatifs des meilleures marques à prix compétitifs
                </p>
              </div>
              <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-full w-16 h-16 flex items-center justify-center mb-4">
                ...
                <p className="text-gray-600 text-sm">
                  Sélection de fabricants reconnus et homologués
                </p>
              </div>
              <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-full w-16 h-16 flex items-center justify-center mb-4">
                ...
                <p className="text-gray-600 text-sm">
                  Vérification de l'adéquation avec votre véhicule
                </p>
              </div>
              <div className="flex flex-col items-center text-center bg-white/80 backdrop-blur rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-full w-16 h-16 flex items-center justify-center mb-4">
                ...
                <p className="text-gray-600 text-sm">
                  Innovations et nouvelles technologies du marché
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-8 flex items-center justify-center gap-8 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span>
                  <strong className="text-gray-900">{totalGuides}</strong>{" "}
                  guides disponibles
                </span>
              </div>
              <div className="flex items-center gap-2">
            ...
            {totalGuides > 0 ? (
                ...
                <div className="relative mb-10">
                  <div className="flex items-center gap-4 p-6 rounded-2xl bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200">
                    ...
                    <div className="flex-1">
                      <h2 className="text-3xl md:text-4xl font-bold text-green-900 mb-1">
                        Tous les guides d'achat
                      </h2>
                      <div className="flex items-center gap-3">
                        <Badge className="bg-success/20 text-success border-green-300">
                          ...
                          <CardContent className="flex-1 p-5">
                            ...
                            <div className="flex items-center gap-4 text-xs text-gray-500 mb-4">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <span>
                                  {formatViews(guide.viewsCount || 0)}
                                </span>
                              </div>
                              {guide.readingTime && (
                                <div className="flex items-center gap-1">
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-600 mb-8">
                  Les guides d'achat seront bientôt disponibles
                </p>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Nos experts vous aident à choisir les pièces adaptées à votre
            véhicule et votre budget
          </p>
