          ...
          >
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  ...
                  {order.priority !== "NORMAL" && (
                    <span
                      className={`px-2 py-1 rounded text-xs font-medium ${getPriorityBadgeStyles(order.priority)}`}
                    >
                      {order.priority}
                    </span>
                  )}
              ...
              <div className="flex flex-col items-end space-y-2">
                <span
                  className={`px-2 py-1 rounded text-xs font-medium ${getStatusBadgeStyles(order.status)}`}
                >
