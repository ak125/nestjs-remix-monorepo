...
const TOP_MARQUES = [
  { name: "Peugeot", alias: "peugeot", id: 128, anchor: "Pièces auto Peugeot" },
  {
    ...
    alias: "renault",
    id: 140,
    anchor: "Pièces détachées Renault",
  },
  ...
  { name: "BMW", alias: "bmw", id: 33, anchor: "Pièces BMW Série 3 & 5" },
  {
    ...
    alias: "mercedes-benz",
    id: 90,
    anchor: "Pièces Mercedes Classe A & C",
  },
...
const TOP_GAMMES = [
  {
    ...
    alias: "plaquettes-de-frein",
    id: 1,
    anchor: "Plaquettes de frein avant/arrière",
  },
  {
    name: "Disque de frein",
    alias: "disque-de-frein",
    id: 2,
    anchor: "Disques de frein ventilés",
  },
  {
    name: "Filtre à huile",
    alias: "filtre-a-huile",
    id: 7,
    anchor: "Filtres à huile moteur",
  },
  {
    name: "Filtre à air",
    alias: "filtre-a-air",
    id: 8,
    anchor: "Filtres à air habitacle",
  },
  {
    name: "Kit de distribution",
    alias: "kit-de-distribution",
    id: 5,
    anchor: "Kit distribution complet",
  },
  {
    name: "Amortisseur",
    alias: "amortisseur",
    id: 15,
    anchor: "Amortisseurs avant/arrière",
  },
  {
    name: "Kit d'embrayage",
    alias: "kit-d-embrayage",
    id: 12,
    anchor: "Kit embrayage + volant moteur",
  },
  {
    name: "Batterie",
    alias: "batterie",
    id: 100,
    anchor: "Batteries auto 12V",
  },
];
...
export const Footer = () => {
  ...
  const handleMarqueClick = (marque: (typeof TOP_MARQUES)[0]) => {
    trackClick(
      "TopMarques",
      `/constructeurs/${marque.alias}-${marque.id}.html`,
      {
  ...
  const _handleFooterLinkClick = (url: string, text: string) => {
