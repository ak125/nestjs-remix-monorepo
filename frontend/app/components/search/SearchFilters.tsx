...
export const SearchFilters = memo(function SearchFilters({
  ...
  const otherFacets = safeFacets.filter(
    (f) => f.field !== "marque" && f.field !== "gamme",
  );
        ...
        <ScrollArea className="flex-1 min-h-0">
          <div className="p-4 space-y-4">
            ...
            >
              <div className="flex gap-2">
                {[
                  ...
                  const isActive =
                    (rating.value === "all" && !currentFilters.minNote) ||
                  ...
                  {marqueFacet.values.slice(0, 12).map((option) => {
                    ...
                    return (
                      <button
                        key={option.value}
                        onClick={() =>
                          handleFilterChange("marque", option.value)
                        }
                  ...
                  {gammeFacet.values.slice(0, 8).map((option) => {
                    ...
                    return (
                      <button
                        key={option.value}
                        onClick={() =>
                          handleFilterChange("gamme", option.value)
                        }
            ...
            >
              <div className="flex gap-1">
                {[
                  ...
                  const isActive =
                    currentFilters.priceRange === price.id ||
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (price.id === "all") {
                          ...
                          if (price.min)
                            newFilters.priceMin = price.min.toString();
                          else delete newFilters.priceMin;
                          if (price.max)
                            newFilters.priceMax = price.max.toString();
            ...
            >
              <div className="space-y-2">
                ...
                >
                  ...
                  <span className="px-1.5 py-0.5 bg-rose-500 text-white text-[8px] font-bold rounded">
                    %
                  </span>
                </label>
                ...
                >
                  ...
                  <span className="px-1.5 py-0.5 bg-blue-500 text-white text-[8px] font-bold rounded">
                    NEW
                  </span>
                </label>
              </div>
            ...
            {otherFacets.map((facet) => {
              const safeValues = Array.isArray(facet.values)
                ? facet.values
                : [];
                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            checked={isSelected}
                            onChange={() =>
                              handleFilterChange(facet.field, option.value)
                            }
                            className="w-4 h-4 rounded border-2 border-slate-300 text-blue-600 focus:ring-blue-500"
                          />
