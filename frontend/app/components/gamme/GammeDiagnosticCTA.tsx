...
export default function GammeDiagnosticCTA() {
  return (
    <Section variant="slate" spacing="sm">
      <div className="bg-white rounded-[24px] shadow-[0_14px_34px_rgba(15,23,42,0.08)] border border-orange-100 overflow-hidden">
        <div className="px-5 pt-4 pb-2 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="text-[17px] lg:text-[20px] font-extrabold text-slate-900 tracking-tight font-heading">
              Diagnostic gratuit
            </h2>
          </div>
        ...
        <div className="px-5 pb-3">
          <p className="text-[13px] text-slate-500 font-normal leading-relaxed font-body">
        ...
        <div className="px-4 pb-4">
          <Link to="/diagnostic-auto">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/[0.12] to-white/0 animate-shimmer" />
