...
export const MotorisationsTable = memo(function MotorisationsTable({
  ...
  return (
    <div
      className={`rounded-xl border border-gray-200 overflow-hidden ${className}`}
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-auto text-sm text-gray-300">
            {motorisations.length} motorisation
            {motorisations.length > 1 ? "s" : ""}
          </span>
        </div>
      </div>
        ...
        <div className="bg-gray-50 border-t border-gray-200 px-4 py-3">
          <div className="flex flex-wrap gap-3 text-xs text-gray-600">
            <div className="flex items-center gap-1">
              <span
                className={`px-2 py-0.5 rounded text-xs font-medium ${levelColors.V1}`}
              >
                V1
              </span>
            ...
            <div className="flex items-center gap-1">
              <span
                className={`px-2 py-0.5 rounded text-xs font-medium ${levelColors.V2}`}
              >
                V2
              </span>
            ...
            <div className="flex items-center gap-1">
              <span
                className={`px-2 py-0.5 rounded text-xs font-medium ${levelColors.V3}`}
              >
                V3
              </span>
            ...
            <div className="flex items-center gap-1">
              <span
                className={`px-2 py-0.5 rounded text-xs font-medium ${levelColors.V4}`}
              >
                V4
              </span>
              <span>Variantes</span>
    ...
    <tr className={`hover:bg-gray-50 ${isV1 ? "bg-blue-50/50" : ""}`}>
      <td className="px-4 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span
            className={isV1 ? "font-semibold text-gray-900" : "text-gray-700"}
          >
