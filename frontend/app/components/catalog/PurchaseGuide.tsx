...
function detectCategory(
  productName?: string,
  familleName?: string,
): "plaquettes_frein" | "disques_frein" | "amortisseurs" | "filtres_air" {
...
export function PurchaseGuide({
  ...
  const [selectedRange, setSelectedRange] = useState<
    "economique" | "qualite_plus" | "premium"
  >("qualite_plus");
      ...
      <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
                      Nous proposons 3 gammes adaptées à votre usage et votre
                      budget. Chaque gamme offre qualité et sécurité, avec des
                      caractéristiques spécifiques selon vos besoins.
                    </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h4 className="font-bold text-lg sm:text-xl mb-1 sm:mb-2 text-gray-900">
                      Économique
                    </h4>
                ...
                <div className="relative bg-white rounded-lg m-1 p-4 sm:p-6 md:p-8 shadow-xl">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      {categoryData.step2_ranges[selectedRange].specs.map(
                        (spec, idx) => (
                          <div
                            key={idx}
            ...
            <div className="relative p-6 md:p-8">
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-4">
                    {categoryData.step3.alerts.map((alert, idx) => (
                      ...
                      >
                        ...
                        <div
                          className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b ${familleColor}`}
                        ></div>

                        {/* Fond avec opacité variable selon le type */}
                        <div
                          className={`relative p-4 md:p-5 ml-1 rounded-r-xl ${
                            alert.type === "danger"
                  ...
                  {"related_gammes" in categoryData.step3 &&
                    categoryData.step3.related_gammes &&
                    categoryData.step3.related_gammes.length > 0 && (
        ...
        <div className="text-center animate-in fade-in zoom-in duration-700 delay-400">
          <Link
            to={
              productAlias
                ? `/blog-pieces-auto/conseils/${productAlias}`
          ...
          >
            ...
            <svg
              className="w-4 h-4 sm:w-5 sm:h-5 relative text-white"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <span className="relative text-white">
              Guide complet {categoryData.name}
            </span>
            <svg
              className="w-4 h-4 sm:w-5 sm:h-5 relative text-white group-hover:translate-x-1 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
