      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-700 text-base">{compatibility.years}</p>
          </div>
        </div>
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-blue-100 text-sm">
                Notre équipe vérifie gratuitement la compatibilité avec votre
                véhicule
              </p>
            </div>
        ...
        <div className="border-t pt-4">
          <p className="text-xs text-gray-500 leading-relaxed">
            ℹ️ Les informations de compatibilité sont fournies à titre
            indicatif. Nous vous recommandons de vérifier la référence d'origine
            de votre pièce avant commande. En cas de doute, contactez notre
            service client avec votre numéro de châssis (VIN).
          </p>
        </div>
      </div>
    </div>
