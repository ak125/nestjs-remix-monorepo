      ...
      <div className="p-6">
        ...
        <div className="mt-6 p-4 bg-teal-50 rounded-lg border border-teal-200">
          <p className="text-xs text-teal-800 flex items-start gap-2">
            ...
            <span>
              Les liens vous redirigent vers les pièces compatibles avec votre <strong>{vehicle.marque} {vehicle.modele} {vehicle.type}</strong>. 
              Tous les produits affichés sont garantis compatibles avec votre motorisation.
            </span>
          </p>
        </div>
      </div>
 ...
 */
export function PiecesCrossSellingCompact({ gammes, vehicle }: PiecesCrossSellingProps) {
