        ...
        {pieces.map((piece, index) => {
          ...
          const priceWhole =
            typeof piece.price === "number"
              ? Math.floor(piece.price)
              : piece.priceFormatted?.split(",")[0] || "0";
          const priceCents =
            typeof piece.price === "number"
              ? (piece.price % 1).toFixed(2).substring(2)
              : piece.priceFormatted?.split(",")[1]?.replace("€", "") || "00";
                ...
                {(() => {
                  ...
                  return (
                    <div className="flex-1 flex items-center justify-end gap-1.5">
                      ...
                      <span
                        className={`text-xs font-black ${getTextColor(reliability)} min-w-[16px]`}
                      >
                        {reliability}
                      </span>
                    </div>
