    ...
    <Card className="overflow-hidden">
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg p-6 border border-primary/20">
            ...
            <div className="space-y-3">
              {guide.tips.map((tip, index) => (
                <div key={index} className="flex items-start gap-3 bg-card rounded-lg p-3 shadow-sm">
        ...
        {guide.warnings && guide.warnings.length > 0 && (
          <div className="bg-gradient-to-br from-destructive/10 to-destructive/5 rounded-lg p-6 border-2 border-destructive/20">
            ...
            <ul className="space-y-2">
              {guide.warnings.map((warning, index) => (
                <li key={index} className="flex items-start gap-2 text-sm text-destructive bg-card rounded p-2">
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-5 text-center border border-primary/20">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <button className="bg-card hover:bg-muted text-primary px-6 py-2 rounded-lg font-medium transition-colors border border-border">
