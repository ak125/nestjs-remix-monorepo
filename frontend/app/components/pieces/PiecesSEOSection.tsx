 ...
 */
function generateSectionContent(section: string, vehicleName: string, gammeName: string): string {
  ...
  if (lowerSection.includes('entretien') || lowerSection.includes('maintenance')) {
