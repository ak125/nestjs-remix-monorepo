...
export default function MotorisationsSection({ 
  ...
  return (
    <section className="bg-white rounded-2xl shadow-xl mb-8 overflow-hidden border border-gray-100">
      ...
      <div className={`relative bg-gradient-to-br ${familleColor} p-6 md:p-8 overflow-hidden`}>
        {/* Effet de brillance */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
          {motorisations.items.map((motorisation, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${familleColor} opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-xl`}></div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-shrink-0">
                    <div className="relative">
                      <div className={`absolute inset-0 bg-gradient-to-br ${familleColor} rounded-xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-300`}></div>
                      <img
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap mb-2.5">
                      <div className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${familleColor} text-white shadow-sm`}>
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed mb-4">
                      {motorisation.description || motorisation.advice || `Trouvez les ${familleName.toLowerCase()} compatibles avec votre ${motorisation.marque_name} ${motorisation.modele_name} ${motorisation.type_name}. Livraison rapide et garantie constructeur.`}
                    </p>
                    
                    {/* CTA amélioré */}
                    <div className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r ${familleColor} text-white font-bold text-sm shadow-md group-hover:shadow-xl transition-all duration-300 group-hover:scale-105`}>
