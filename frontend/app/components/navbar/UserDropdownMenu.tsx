      ...
      <DropdownMenuContent className="w-72 p-2" align="end" forceMount>
        ...
        <DropdownMenuGroup className="space-y-1">
          <DropdownMenuItem asChild>
            <Link
              ...
              className="flex items-center gap-3 cursor-pointer px-3 py-2.5 rounded-lg hover:bg-blue-50 transition-all group"
            >
          ...
          <DropdownMenuItem asChild>
            <Link
              ...
              className="flex items-center gap-3 cursor-pointer px-3 py-2.5 rounded-lg hover:bg-green-50 transition-all group"
            >
        ...
        <DropdownMenuGroup className="space-y-1">
          ...
          <DropdownMenuItem asChild>
            <Link
              to="/account/settings"
              className="flex items-center gap-3 cursor-pointer px-3 py-2.5 rounded-lg hover:bg-slate-50 transition-all group"
            >
