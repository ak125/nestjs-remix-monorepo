...
export const VehicleFilterBadge = memo(function VehicleFilterBadge({
  vehicle,
  onClear,
  showDetails = true,
  className = "",
 ...
 */
export const VehicleFilterBadgeCompact = memo(
  function VehicleFilterBadgeCompact({
    vehicle,
    onClear,
  }: VehicleFilterBadgeProps) {
    const handleClear = () => {
 ...
 */
export const VehicleFilterChip = memo(function VehicleFilterChip({
  vehicle,
  onClear,
}: VehicleFilterBadgeProps) {
  const handleClear = () => {
