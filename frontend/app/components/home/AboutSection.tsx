...
export function AboutSection({ 
  ...
  return (
    <div className={`bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-16 ${className}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Depuis notre création, nous avons développé une expertise unique dans la distribution 
                de pièces automobiles. Notre équipe de spécialistes vous accompagne dans le choix 
                des pièces adaptées à votre véhicule.
              </p>
              
              <p>
                Que vous soyez un particulier passionné d'automobile ou un professionnel du secteur, 
                nous mettons notre savoir-faire à votre service pour vous garantir des pièces 
                de qualité OE (Original Equipment) ou équivalent.
              </p>
              
              <p>
                Notre catalogue comprend plus de 50 000 références couvrant toutes les marques 
                et tous les modèles. Nous travaillons exclusivement avec des fabricants reconnus 
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <div className="text-gray-600 font-medium">Marques référencées</div>
            </div>
        ...
        <div className="border-t border-gray-200 pt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Nos conseillers techniques vous guident dans le choix de vos pièces
              </p>
            </div>
