...
export class SearchService {
  ...
  private async searchByVehicleCode(params: SearchParams): Promise<SearchResult> {
    ...
    // Rechercher les pièces compatibles avec ce véhicule
  ...
  /**
   * 📋 Recherche par référence (remplace search.fiche.php)
   */
  ...
  /**
   * ⚡ Recherche instantanée (remplace search.fiche.call.php)
   */
  async instantSearch(query: string): Promise<SearchResult> {
    ...
    // Recherche rapide limitée pour l'auto-complétion
