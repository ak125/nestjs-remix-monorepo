...
import { OrdersAutomotiveIntegrationService } from './orders-automotive-integration.service';
...
export class AutomotiveOrdersService {
  ...
  constructor(
    ...
    private readonly integrationService: OrdersAutomotiveIntegrationService,
