...
/**
 * Schéma Zod de base pour un produit automobile (sans validation croisée)
 */
...
/**
 * Schéma Zod pour la création d'un produit avec validations croisées
 */
 ...
 * Utilise .partial() sur le schéma de base pour rendre tous les champs optionnels
 */
