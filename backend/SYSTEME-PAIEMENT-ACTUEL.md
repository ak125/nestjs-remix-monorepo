...
$CertificatTest = "<SET_IN_ENV>";
$CertificatProd = "<SET_IN_ENV>";
$CertificatToUse = $CertificatProd;  // ✅ PRODUCTION ACTIVE

// Identifiants marchands
Site ID : 43962882
Certificat PROD : <SET_IN_ENV>
Mode : PRODUCTION
...
- **Certificats** : 16 caractères (ex: `1234567890123456`)
