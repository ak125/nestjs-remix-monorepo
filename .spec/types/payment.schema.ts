 ...
 * 
 * @module payment.schema
 * @description Schémas de validation Zod pour le système de paiement Paybox
 * @version 1.0.0
 * @created 2025-01-14
 * @updated 2025-11-18
 * @relates-to
...
/**
 * Schema pour callback IPN Paybox
 */
...
/**
 * Schema pour filtres de recherche paiements
 */
...
/**
 * Schema pour statistiques paiements
 */
...
export type PayboxErrorCode = z.infer<typeof PayboxErrorCodeSchema>;
...
export default {
  ...
  PaymentStatus,
  CreatePaymentSchema,
  PayboxCallbackSchema,
  RefundPaymentSchema,
  PaymentFiltersSchema,
  PaymentResponseSchema,
  PaymentStatisticsSchema,
  PayboxErrorCodes,
  PayboxErrorCodeSchema,
};
