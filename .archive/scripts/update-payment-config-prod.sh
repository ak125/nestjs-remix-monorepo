...
if grep -q "^SYSTEMPAY_CERTIFICATE_TEST=" .env; then
    sed -i "s/^SYSTEMPAY_CERTIFICATE_TEST=.*/SYSTEMPAY_CERTIFICATE_TEST=${SYSTEMPAY_CERTIFICATE_TEST:?SYSTEMPAY_CERTIFICATE_TEST manquant}/" .env
    echo "  âœ… SYSTEMPAY_CERTIFICATE_TEST mis a jour (valeur masquee)"
else
    echo "SYSTEMPAY_CERTIFICATE_TEST=${SYSTEMPAY_CERTIFICATE_TEST:?SYSTEMPAY_CERTIFICATE_TEST manquant}" >> .env
    echo "  âœ… SYSTEMPAY_CERTIFICATE_TEST ajoute (valeur masquee)" # (ajoutÃ©)"
fi

# Mise Ã  jour SYSTEMPAY_CERTIFICATE_PROD
if grep -q "^SYSTEMPAY_CERTIFICATE_PROD=" .env; then
    sed -i "s/^SYSTEMPAY_CERTIFICATE_PROD=.*/SYSTEMPAY_CERTIFICATE_PROD=${SYSTEMPAY_CERTIFICATE_PROD:?SYSTEMPAY_CERTIFICATE_PROD manquant}/" .env
    echo "  âœ… SYSTEMPAY_CERTIFICATE_PROD mis a jour (valeur masquee)"
else
    echo "SYSTEMPAY_CERTIFICATE_PROD=${SYSTEMPAY_CERTIFICATE_PROD:?SYSTEMPAY_CERTIFICATE_PROD manquant}" >> .env
    echo "  âœ… SYSTEMPAY_CERTIFICATE_PROD ajoute (valeur masquee)" # (ajoutÃ©)"
fi
